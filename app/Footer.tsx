...
import { Download, MailIcon, PhoneCallIcon, PinIcon } from "lucide-react";
					...
					<div className="flex flex-col gap-6 py-10 lg:items-start lg:flex-row ">
						<div className="flex flex-col justify-start w-full lg:w-1/4">
							...
							<p className="mt-3 text-sm text-white">
								Contributing to the betterment of its communities’ lives through
								a participatory development process to ensure that they have
                ...
                />
						...
						<div className="flex flex-col justify-start w-full lg:w-1/4">
							...
							<div className="mt-4">
								...
								<div className="flex space-x-2">
									<Download strokeWidth={1} size={32} className="text-white" />
									<Link
										href="/documents/paia.pdf"
