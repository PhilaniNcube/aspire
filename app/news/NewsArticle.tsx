...
const NewsArticle = ({newsItem}:Props) => {
  return <article className="w-full overflow-hidden rounded-md">
    <Image src={newsItem.image ? newsItem.image : "/images/news.jpg" } width={1920} height={1280} alt={newsItem.name!} className="object-cover object-top w-full aspect-video" />
    <div className="p-3">
